...
Create the following JavaScript bookmarklet (create a new bookmark and past this as the URL):
    ...
    javascript:(function(){var d=document,s=d.createElement('script');s.src='https://rawgit.com/acidnik/cbc-kitten-scientists/dev/kitten-scientists.js';d.body.appendChild(s);})();
